...
const names = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chain(users)
    .map(user => user.name)
    .join(',')
    .value();
...
const minAge = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chain(users)
    .map(user => user.age)
    .max(age => age)
    .value();
...
const sort = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chain(users)
    .sortBy('age')
    .map(user => user.age)
    .first()
    .value();
...
const obj = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chain(usersObj)
    .map(user => {
...
const chunk = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.chunk([1, 2, 3, 4, 5, 6], 3)
// console.log(chunk)
